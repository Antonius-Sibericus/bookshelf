...
export class PublishedService {
    ...
    public async get(req: Request, res: Response) {
        try {
            ...
            if (!booksInFavorites) throw new NotFoundException('Книги в опубликованном не найдены')
    ...
    public async add(req: Request, bookTag: string, res: Response) {
        try {
            ...
            if (!favorites) throw new NotFoundException('Опубликованное пользователя не найдено')
            ...
            if (!updatedFavorites) throw new NotImplementedException(`Не удалось добавить книгу ${bookTag} в опубликованное пользователя`)
    ...
    public async remove(req: Request, bookTag: string, res: Response) {
        try {
            ...
            if (!updatedFavorites) { throw new NotImplementedException(`Не удалось убрать книгу ${bookTag} из опубликованного пользователя`) }
