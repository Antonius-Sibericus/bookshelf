...
import { ColorThemeEnum, type ColorThemeType } from '../../../../redux/colorTheme/colorTheme.types'
                ...
                <div className={styles.headerContent}>
                    <div className={styles.headerTop}>
                        <div className={styles.headerTopMenu}>
                            <nav>
                                <ul>
                                    <li><Link to='/' className={theme === ColorThemeEnum.LIGHT ? styles.light : styles.dark}>Главная</Link></li>
                                    <li><Link to='/catalog' className={theme === ColorThemeEnum.LIGHT ? styles.light : styles.dark}>Каталог</Link></li>
                                </ul>
                            </nav>
                        </div>
                        <a className={styles.headerTopPhone + ' ' + (theme === ColorThemeEnum.LIGHT ? styles.light : styles.dark)} href='tel:+375299182888'>8 (800) 555-35-35</a>
                        <div className={styles.headerTopActions}>
                            {theme === ColorThemeEnum.LIGHT ?
                                <a onClick={changeTheme}>
                                    <svg fill={'#072e36'} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                                        <path d="M223.5 32C100 32 0 132.3 0 256S100 480 223.5 480c60.6 0 115.5-24.2 155.8-63.4c5-4.9 6.3-12.5 3.1-18.7s-10.1-9.7-17-8.5c-9.8 1.7-19.8 2.6-30.1 2.6c-96.9 0-175.5-78.8-175.5-176c0-65.8 36-123.1 89.3-153.3c6.1-3.5 9.2-10.5 7.7-17.3s-7.3-11.9-14.3-12.5c-6.3-.5-12.6-.8-19-.8z" />
                                    </svg>
                                </a> :
                                <a onClick={changeTheme}>
                                    <svg fill={'#072e36'} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            ...
                            <Link to={true ? '/signup' : '/login'}>
                                <svg stroke={'#072e36'} width='23' height='23' viewBox='0 0 23 23' fill='none' xmlns='http://www.w3.org/2000/svg'>
                                    <path
                            ...
                            <Link to='/profile/1'>
                                <svg stroke={'#072e36'} fill='none' width='24' height='24' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
                                    <path
                    ...
                    </div>
                    {
                        ...
                        <div className={styles.headerBottom}>
                            <div className={styles.headerBottomMenu}>
                                <nav>
                                    <ul>
                                        <li><Link to='/catalog'>Category</Link></li>
                                        <li><Link to='/catalog'>Category</Link></li>
                                        <li><Link to='/catalog'>Category</Link></li>
                                        <li><Link to='/catalog'>Category</Link></li>
                                    </ul>
